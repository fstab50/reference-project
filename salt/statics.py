"""
Summary:
    Project-level Defaults and Settings

    - **Local Default Settings**: Local defaults for your specific installation
        are derived from settings found in:
...
try:
    ...
    # config parameters
    CONFIG_SCRIPT = 'pdfconfig'         # console script to access config file
    config_dir = '.config'
